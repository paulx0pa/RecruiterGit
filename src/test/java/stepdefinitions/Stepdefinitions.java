...
public void choose_primary_recruiter() throws Throwable {
...
public void user_clicks_on_Add_Collaborator_option() throws Throwable {
	Thread.sleep(2000);
	driver.findElement(By.xpath("(//button[text()='Add Collaborator'])[2]")).click(); 
	Thread.sleep(2000);
...
@When("^recruiter clicks on candidate's resume$")
public void recruiter_clicks_on_candidate_s_resume() throws Throwable {
	WebElement resume=driver.findElement(By.xpath("(//a[@class='sui-single-option-facet__link inactive'])[1]"));
  resume.click();
  js.executeScript("window.scrollBy(0,1000)");
  Thread.sleep(3000);
}
@When("^recruiter clicks on candidate's interview status$")
public void recruiter_clicks_on_candidate_s_interview_status() throws Throwable {
	WebElement interviewstatus=driver.findElement(By.xpath("(//a[@class='sui-single-option-facet__link inactive'])[2]"));
	interviewstatus.click();
	
}

@When("^recruiter clicks on candidate's approvals table$")
public void recruiter_clicks_on_candidate_s_approvals_table() throws Throwable {
	WebElement approvalstable=driver.findElement(By.linkText("Approvals Table"));
	approvalstable.click();
	Thread.sleep(3000);
	
}

@When("^recruiter clicks on candidate's collaborators$")
public void recruiter_clicks_on_candidate_s_collaborators() throws Throwable {
	WebElement collaborators=driver.findElement(By.xpath("(//a[@class='sui-single-option-facet__link inactive'])[4]"));
	collaborators.click();
	Thread.sleep(3000);
}

@When("^recruiter clicks on candidate's Applicant notes$")
public void recruiter_clicks_on_candidate_s_Applicant_notes() throws Throwable {
	WebElement applicantnotes=driver.findElement(By.xpath("(//a[@class='sui-single-option-facet__link inactive'])[5]"));
    applicantnotes.click();  
    js.executeScript("window.scrollBy(0,1000)");
    Thread.sleep(3000);
}

@When("^recruiter clicks on candidate's references$")
    public void recruiter_clicks_on_candidate_s_references()throws Throwable {
	WebElement references=driver.findElement(By.xpath("(//a[@class='sui-single-option-facet__link inactive'])[6]"));
	references.click();
	js.executeScript("window.scrollBy(0,1000)");
	Thread.sleep(3000);
}

@When("^recruiter clicks on candidate's offer information$")
public void recruiter_clicks_on_candidate_s_offer_information() throws Throwable {
	WebElement offerinfo=driver.findElement(By.xpath("(//a[@class='sui-single-option-facet__link inactive'])[7]"));
    offerinfo.click();
    js.executeScript("window.scrollBy(0,1000)");
    Thread.sleep(3000);
}

@When("^recruiter clicks on candidate's other jobs applied$")
public void recruiter_clicks_on_candidate_s_other_jobs_applied() throws Throwable {
	WebElement otherjobsapplied=driver.findElement(By.xpath("(//a[@class='sui-single-option-facet__link inactive'])[8]"));
otherjobsapplied.click();
js.executeScript("window.scrollBy(0,1000)");
Thread.sleep(3000);
}

@When("^recruiter clicks on candidate's suitable jobs$")
public void recruiter_clicks_on_candidate_s_suitable_jobs() throws Throwable {
	WebElement suitablejobs=driver.findElement(By.xpath("(//a[@class='sui-single-option-facet__link inactive'])[9]"));
	suitablejobs.click();
	js.executeScript("window.scrollBy(0,1000)");
	Thread.sleep(3000);
}

@When("^recruiter clicks on candidate's chat with candidate$")
public void recruiter_clicks_on_candidate_s_chat_with_candidate() throws Throwable {
	WebElement chatwithcandidate=driver.findElement(By.xpath("(//a[@class='sui-single-option-facet__link inactive'])[10]"));
	chatwithcandidate.click();
	js.executeScript("window.scrollBy(0,1000)");
	Thread.sleep(3000);
}

@When("^recruiter clicks on candidate's post hire feedback$")
public void recruiter_clicks_on_candidate_s_post_hire_feedback() throws Throwable {
	WebElement posthirefeedback=driver.findElement(By.xpath("(//a[@class='sui-single-option-facet__link inactive'])[11]"));
	posthirefeedback.click();
	js.executeScript("window.scrollBy(0,1000)");
	Thread.sleep(3000);
}

@When("^recruiter clicks on candidate's onboarding$")
public void recruiter_clicks_on_candidate_s_onboarding() throws Throwable {
	WebElement onboarding=driver.findElement(By.xpath("(//a[@class='sui-single-option-facet__link inactive'])[12]"));
    onboarding.click();
    js.executeScript("window.scrollBy(0,1000)");
    Thread.sleep(3000);
}

@When("^recruiter clicks on candidate's timeline$")
public void recruiter_clicks_on_candidate_s_timeline() throws Throwable {
	WebElement timeline=driver.findElement(By.xpath("(//a[@class='sui-single-option-facet__link inactive'])[13]"));
    timeline.click();
    js.executeScript("window.scrollBy(0,1000)");
    Thread.sleep(3000);
}

@When("^recruiter clicks on candidate's contact numbers$")
public void recruiter_clicks_on_candidate_s_contact_numbers() throws Throwable {
	driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
	WebElement contactnos=driver.findElement(By.xpath("(//a[@class='sui-single-option-facet__link inactive'])[14]"));
	contactnos.click();
	js.executeScript("window.scrollBy(0,1000)");
	Thread.sleep(3000);
}
